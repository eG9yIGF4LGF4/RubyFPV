...
FOLDER_PLUGINS_CORE=code/r_plugins_core
...
$(FOLDER_PLUGINS_CORE)/%.o: $(FOLDER_PLUGINS_CORE)/%.cpp
	$(CXX) $(_CFLAGS) -c -o $@ $<
...
MODULE_RADIO := $(FOLDER_COMMON)/radio_stats.o $(FOLDER_RADIO)/fec.o $(FOLDER_RADIO)/radio_duplicate_det.o $(FOLDER_RADIO)/radio_rx.o $(FOLDER_RADIO)/radio_tx.o $(FOLDER_RADIO)/radiolink.o $(FOLDER_RADIO)/radiopackets_rc.o $(FOLDER_RADIO)/udplink.o $(FOLDER_RADIO)/radiopackets_short.o $(FOLDER_RADIO)/radiopackets2.o $(FOLDER_RADIO)/radiopacketsqueue.o $(FOLDER_RADIO)/radiotap.o
MODULE_VEHICLE := $(FOLDER_VEHICLE)/shared_vars.o $(FOLDER_VEHICLE)/timers.o $(FOLDER_VEHICLE)/adaptive_video.o $(FOLDER_VEHICLE)/negociate_radio.o $(FOLDER_VEHICLE)/generic_tx_ecbuffers.o $(FOLDER_RUTILS)/udplink.o $(FOLDER_UTILS)/utils_vehicle.o $(FOLDER_VEHICLE)/launchers_vehicle.o $(FOLDER_BASE)/vehicle_rt_info.o
MODULE_STATION := $(FOLDER_STATION)/shared_vars.o $(FOLDER_STATION)/shared_vars_state.o $(FOLDER_STATION)/timers.o $(FOLDER_STATION)/adaptive_video.o $(FOLDER_RUTILS)/udplink.o 
...
ruby_central: $(FOLDER_CENTRAL)/ruby_central.o $(MODULE_BASE) $(MODULE_MODELS) $(MODULE_COMMON) $(MODULE_BASE2) $(CENTRAL_MENU_ITEMS_ALL) $(CENTRAL_MENU_ALL1) $(CENTRAL_RENDER_CODE) $(CENTRAL_MENU_ALL2) $(CENTRAL_MENU_ALL3) $(CENTRAL_MENU_ALL4) $(CENTRAL_MENU_ALL5) $(CENTRAL_MENU_ALL6) $(CENTRAL_MENU_RC)  $(CENTRAL_MENU_RADIO) $(CENTRAL_POPUP_ALL) $(CENTRAL_RENDER_ALL) $(CENTRAL_OSD_ALL) $(CENTRAL_OLED_ALL) $(CENTRAL_ALL) $(CENTRAL_RADIO) $(FOLDER_BASE)/shared_mem_controller_only.o $(FOLDER_BASE)/hdmi.o $(FOLDER_COMMON)/favorites.o $(FOLDER_BASE)/plugins_settings.o \
	$(FOLDER_BASE)/core_plugins_settings.o $(FOLDER_BASE)/hardware_files.o $(FOLDER_COMMON)/models_connect_frequencies.o $(FOLDER_BASE)/shared_mem_i2c.o $(FOLDER_BASE)/video_capture_res.o $(FOLDER_RADIO)/udplink.o
...
ruby_start: $(FOLDER_START)/ruby_start.o $(FOLDER_START)/r_start_vehicle.o $(MODULE_LOC) $(FOLDER_START)/r_test.o $(FOLDER_START)/r_initradio.o $(FOLDER_START)/first_boot.o $(FOLDER_RADIO)/udplink.o $(FOLDER_RUTILS)/udplink.o \
...
ruby_plugins: ruby_plugin_osd_ahi ruby_plugin_gauge_speed ruby_plugin_gauge_altitude ruby_plugin_gauge_ahi ruby_plugin_gauge_heading #ruby_plugin_keyboard
...
ruby_plugin_keyboard: $(FOLDER_PLUGINS_CORE)/plugin_core_keyboard.o core_plugins_utils.o
	gcc $(FOLDER_PLUGINS_CORE)/plugin_core_keyboard.o core_plugins_utils.o -shared -Wl,-soname,ruby_plugin_keyboard.so.1 -o ruby_plugin_keyboard.so.1.0.1 -lc
