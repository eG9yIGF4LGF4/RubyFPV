...
#define IP_TUNNEL_ADDR_STATION  "172.17.0.1"
#define IP_TUNNEL_ADDR_VEHICLE  "172.19.0.1"
...
{
    s_is_controller = hardware_is_station();
     ...
     */
    const char *local_ip  = s_is_controller ? IP_TUNNEL_ADDR_STATION  : IP_TUNNEL_ADDR_VEHICLE;
    const char *remote_ip = s_is_controller ? IP_TUNNEL_ADDR_VEHICLE : IP_TUNNEL_ADDR_STATION;
